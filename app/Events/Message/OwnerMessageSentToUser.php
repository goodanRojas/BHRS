...
class OwnerMessageSentToUser implements ShouldBroadcast
{
    ...
    {
        return [
            new PrivateChannel('owner-to-user-messages.' . $this->message->receiver_id),
        ];
    }
    public function broadcastAs()
    {
        return 'OwnerMessageSentToUser';
    }
