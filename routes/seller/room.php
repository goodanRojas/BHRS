...
Route::prefix('seller/room')->name('seller.room.')->middleware(['seller', 'check.has.subscription:bronze,silver,gold'])->group(function () {

    Route::get('/{room}', [RoomController::class, 'showRoom'])->name('details');
    ...
    Route::delete('/delete/{room}', [RoomController::class, 'deleteRoom'])->name('delete');

    Route::post('/update-name/{room}', [RoomController::class, 'updateName'])->name('update.name');
