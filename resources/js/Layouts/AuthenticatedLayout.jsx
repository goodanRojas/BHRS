...
import { SupportCountContext } from '@/Contexts/SupportCountContext';
...
export default function AuthenticatedLayout({ header, children }) {
    ...
    const [showingNavigationDropdown, setShowsetFavoritesCountingNavigationDropdown] = useState(false);
    ...
    const updateSupportCount = (change) => {
    ...
    return (
        <FavoriteContext.Provider value={{ favoritesCount, updateFavoritesCount }}>
            <SupportCountContext.Provider value={{ supportCount, updateSupportCount }}>
