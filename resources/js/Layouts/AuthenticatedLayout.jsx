...
/* 
        ...
        return () => {
            if (window.Echo) {
                ...
                window.Echo.leave(`group-messages.${user.id}`);
                window.Echo.leave(`bot-messages.${user.id}`);
            }
        }
    }, []);
    return (
                            ...
                            <div className="relative">
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <button
                                            type="button"
                                            className="inline-flex items-center rounded-full bg-white px-3 py-2 text-sm font-medium text-gray-600 shadow-sm hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-400 hover:scale-105 transition-transform duration-200"
                                        >
