...
// Example static routes keyed by building id
const STATIC_ROUTES = {
  8: [
    {
      coordinates: [
        [124.98581583228766, 10.24932583809331], // building 8
        [124.988, 10.2505],
      ],
    },
    {
      coordinates: [
        [124.98581583228766, 10.24932583809331],
        [124.990, 10.248],
      ],
    },
    {
    ...
    function addDomMarkers() {
      ...
      features.forEach((feature) => {
        ...
        el.addEventListener('click', (e) => {
          ...
          const routes = STATIC_ROUTES[buildingId] || [];
