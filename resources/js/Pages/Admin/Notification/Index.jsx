...
export default function Index({ notifications, highlight }) {
    ...
    // Mark all as read
    const markAllAsRead = () => {
        router.post(route("admin.notification.markAllRead"), {}, {
            onSuccess: () => {
    ...
    const markAsRead = (id) => {
        router.post(route("admin.notification.markAsRead", id), {}, {
            onSuccess: () => {
                setList(prev =>
    ...
    const handleDelete = () => {
        router.delete(route("admin.notification.destroy", deleteId), {
            onSuccess: () => {
    ...
    const handleDeleteAll = () => {
        ...
        router.delete(route("admin.notification.destroyAll", { type }), {
            onSuccess: () => {
