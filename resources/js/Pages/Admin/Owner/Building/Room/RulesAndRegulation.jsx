...
export default function RulesAndRegulation({ sellerId, buildingId }) {
    ...
    const fetchRules = () => {
        setLoading(true);
        axios.get(`/admin/building/${buildingId}/${sellerId}/rules`)
    ...
    const handleAddRule = (e) => {
        ...
        axios.post(`/admin/building/${buildingId}/${sellerId}/rules`, { title: newRuleTitle, description: newRuleDesc })
            .then((res) => {
    ...
    const handleUpdateRule = (e) => {
        ...
        axios.put(`/admin/building/rules/${editRuleId}`, { title: editTitle, description: editDesc })
            .then((res) => {
    ...
    const handleDelete = (ruleId) => {
        ...
        axios.delete(`/admin/building/rules/${ruleId}`)
